...
const ProfesseurStatistiques = () => {
  ...
  const progressChartInstance = useRef(null); // Instance pour détruire/recréer le graphique
    ...
    if (soumissions.length > 0) {
      ...
      progressChartInstance.current = new Chart(progressCtx, {
        ...
        data: {
          ...
          datasets: [{
            label: 'Note moyenne',
            data: monthlyProgress.data, // Notes moyennes
            borderColor: '#2563eb',
            fill: false,
          }],
        },
...
export default ProfesseurStatistiques;